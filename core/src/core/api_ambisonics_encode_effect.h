...
class CAmbisonicsEncodeEffect : public IAmbisonicsEncodeEffect
{
public:
    Handle<AmbisonicsEncodeEffect> mHandle;

    CAmbisonicsEncodeEffect(CContext* context,
                            IPLAudioSettings* audioSettings,
                            IPLAmbisonicsEncodeEffectSettings* effectSettings);

    virtual IAmbisonicsEncodeEffect* retain() override;
