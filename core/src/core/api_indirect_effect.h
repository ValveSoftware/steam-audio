...
class CReflectionEffect : public IReflectionEffect
{
public:
    Handle<IndirectEffect> mHandle;

    CReflectionEffect(CContext* context,
                      IPLAudioSettings* audioSettings,
                      IPLReflectionEffectSettings* effectSettings);

    virtual IReflectionEffect* retain() override;
...
class CReflectionMixer : public IReflectionMixer
{
public:
    Handle<IndirectMixer> mHandle;

    CReflectionMixer(CContext* context,
                     IPLAudioSettings* audioSettings,
                     IPLReflectionEffectSettings* effectSettings);

    virtual IReflectionMixer* retain() override;
