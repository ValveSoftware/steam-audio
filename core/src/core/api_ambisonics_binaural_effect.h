...
class CAmbisonicsBinauralEffect : public IAmbisonicsBinauralEffect
{
public:
    Handle<AmbisonicsBinauralEffect> mHandle;

    CAmbisonicsBinauralEffect(CContext* context,
                              IPLAudioSettings* audioSettings,
                              IPLAmbisonicsBinauralEffectSettings* effectSettings);

    virtual IAmbisonicsBinauralEffect* retain() override;
