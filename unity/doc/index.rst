...
This document describes the Steam Audio Unity integration, which lets you use Steam Audio to add a variety of spatial audio features to your Unity project. You can use it with Unity's built-in audio engine, or with third-party audio middleware like FMOD Studio.
