...
int UNITY_AUDIODSP_CALLBACK iplUnityAddSOFAFileName(char* sofaFileName)
{
    return AudioEngineSettings::addSOFAFile(sofaFileName);
}

void UNITY_AUDIODSP_CALLBACK iplUnityRemoveSOFAFileName(char* sofaFileName)
{
    AudioEngineSettings::removeSOFAFile(sofaFileName);
}

void UNITY_AUDIODSP_CALLBACK iplUnitySetCurrentSOFAFile(int index)
{
