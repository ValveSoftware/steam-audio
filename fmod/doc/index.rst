...
.. toctree::
    :maxdepth: 2
    :hidden:
    :caption: FMOD Studio Integration
...
This document describes the Steam Audio FMOD Studio integration, which lets you use Steam Audio to add a variety of spatial audio features to your FMOD Studio project.
