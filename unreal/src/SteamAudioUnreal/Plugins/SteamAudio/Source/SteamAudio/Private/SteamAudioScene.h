...
/**
 * Loads the material data of specified StaticMeshActor in the iplStaticMesh object.
 */
void STEAMAUDIO_API UpdateStaticMeshMaterial(UWorld* World, ULevel* Level, IPLStaticMesh StaticMesh, AActor* RefreshableActor);
